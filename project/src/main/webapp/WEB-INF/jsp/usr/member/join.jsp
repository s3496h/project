			...
			<table class="table" border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
				<tbody>
					<tr>
						...
						<td style="text-align: center;">
							<input onkeyup="checkLoginIdDupDebounced(this);"
								class="input input-bordered  input-sm w-full max-w-xs" name="loginId" autocomplete="off"
					...
					<tr>
						<th>비밀번호</th>
						<td style="text-align: center;">
							<input class="input input-bordered  input-sm w-full max-w-xs" name="loginPw" autocomplete="off"
					...
					<tr>
						<th>이름</th>
						<td style="text-align: center;">
							<input class="input input-bordered  input-sm w-full max-w-xs" name="name" autocomplete="off"
					...
					<tr>
						<th>닉네임</th>
						<td style="text-align: center;">
							<input class="input input-bordered  input-sm w-full max-w-xs" name="nickname" autocomplete="off"
					...
					<tr>
						<th>전화번호</th>
						<td style="text-align: center;">
							<input class="input input-bordered  input-sm w-full max-w-xs" name="cellphoneNum" autocomplete="off"
					...
					<tr>
						<th>이메일</th>
						<td style="text-align: center;">
							<input class="input input-bordered  input-sm w-full max-w-xs" name="email" autocomplete="off"
					...
					<tr>
						<th></th>
						<td style="text-align: center;">
							<button type="submit" class="btn btn-active">가입</button>
						</td>
